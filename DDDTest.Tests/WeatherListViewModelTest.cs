...
namespace DDDTest.Tests
{
    ...
    public class WeatherListViewModelTest
    {
        ...
        public void 天気一覧シナリオ()
        {
            ...
            entities.Add(new WeatherEntity(1, "東京",Convert.ToDateTime("2020/01/01 12:34:56"), 2, 12.3f));
            entities.Add(new WeatherEntity(2,"神戸", Convert.ToDateTime("2020/01/02 12:34:56"), 1, 22.3f));
            ...
            viewModel.Weathers[0].DataDate.Is("2020/01/01 12:34:56");
            viewModel.Weathers[0].Confition.Is("曇り");
